...
Route::delete('/{todoId}', [\App\Http\Controllers\TodoController::class, 'destroy'])->name('todo.destroy');
Route::put('/changeStatus/{todoId}', [\App\Http\Controllers\TodoController::class, 'changeStatus'])->name('todo.changeStatus');
